...
function drawScene() {
	...
	spotLightColor = [1.0, 1.0, 0.3];
	spotLightPos = [0.0, 1.0, 0.0];
	write();
	animate();
	updateDirection();
	collisionDetection();
    ...
    var spotLightPosTransformed = utils.multiplyMatrixVector(viewMatrix, spotLightPos);
	// draws the request
	...
	gl.uniform1f(program.coneInUniform, 30.0);
	gl.uniform1f(program.coneOutUniform, 30.0);
