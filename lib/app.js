...
function drawScene() {
	...
	projectionMatrix = utils.MakePerspective(65, canvas.width / canvas.height, 0.1, 500.0);
...
function setDirectionalLight() {
	...
	directionalLightColor = [0.9, 0.9, 1.0];
...
function drawShip() {
	...
	gl.uniform1i(program.albedoSamplerUniform, 1);
	gl.uniform1i(program.normalSamplerUniform, 2);
	gl.uniform1i(program.metalSamplerUniform, 3);
	gl.uniform1i(program.roughSamplerUniform, 4);
	gl.uniform1i(program.AOSamplerUniform, 5);
	gl.uniform1i(program.heightSamplerUniform, 6);
...
function drawAsteroids() {
	...
	gl.uniform1i(program.normalSamplerUniform, 8);
	gl.uniform1i(program.metalSamplerUniform, 9);
	gl.uniform1i(program.roughSamplerUniform, 10);
	gl.uniform1i(program.AOSamplerUniform, 11);
	gl.uniform1i(program.heightSamplerUniform, 12);
	gl.enable(gl.DEPTH_TEST);
