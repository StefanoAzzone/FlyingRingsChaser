...
function drawSkybox() {
	...
	gl.uniform1i(program.cubemap, 20);
...
function drawAsteroids() {
	...
	for(i = 0; i < asteroids.length; i++) {
		if (asteroids[i].active) {
			gl.uniform1i(program.albedoSamplerUniform, 7);
			gl.uniform1f(program.animationUniform, 0.0);
			...
			gl.uniform1i(program.albedoSamplerUniform, 19);
